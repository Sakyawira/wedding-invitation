...
`,Xi="/wedding-invitation/assets/images/13-4dd5e88e.jpg",Ki=h.div`
  position: fixed;
  inset: 0;
  z-index: -999;
...
Location: ${e.address2}`),w=encodeURIComponent(e.address2);return`https://calendar.google.com/calendar/render?action=TEMPLATE&text=${f}&dates=${y}/${b}&details=${g}&location=${w}&ctz=Asia/Jakarta`})();return x(xa,{children:[x(At,{children:[c(Xe,{children:t[1].title}),c(Ke,{children:t[1].desc}),c(ba,{src:e.googleMap})]}),x(At,{children:[c(Xe,{children:t[0].title}),c(Ke,{children:t[0].desc}),c(ya,{id:"google-calendar-link",target:"_blank",href:n,rel:"noreferrer",children:"Add to Calendar"})]})]})},xa=h.div`
  width: 90%;
  display: flex;
  flex-direction: column;
`,At=h.div`
