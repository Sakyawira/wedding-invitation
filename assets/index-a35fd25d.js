...
`,Ni=()=>A(Fi,{children:[A(qn,{children:["Please confirm whether you will attend our wedding!",c("br",{}),"We would love to know before January 28, 2026. 💌"]}),c(Oi,{})]}),Fi=p.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
  margin-bottom: 50px;
...
`,qi=p.button`
  ...
  justify-content: center;
  align-items: center;
`.withComponent("a"),Gi=()=>{const{mapInfo:e,locationInfo:t}=ne;return A(Xi,{children:[A(Pt,{children:[c(Xe,{children:t[1].title}),c(Ke,{children:t[1].desc}),c(Hi,{src:e.googleMap})]}),A(Pt,{children:[c(Xe,{children:t[0].title}),c(Ke,{children:t[0].desc}),c(qi,{id:"google-calendar-link",target:"_blank",href:"https://calendar.app.google/oBYAttRPsaaLUvsVA",rel:"noreferrer",children:"Add to Calendar"})]})]})},Xi=p.div`
  width: 90%;
  display: flex;
  flex-direction: column;
`,Pt=p.div`
